                    ...
                    <div v-else class="card-body">
                        <div v-if="!canedit" class="row">
                            <div class="col-5 justify-content-end">
                                ...
                                <h6 class="mb-2 text-end">Codigo:</h6>
                                <h6 class="mb-2 text-end">Nombre:</h6>
                                <h6 class="mb-2 text-end">Descripción:</h6>
                            </div>
                            <div class="col-7">
                                <h6 class="mb-2"><span class="text-sm text-secondary">{{edit.codigo}}</span></h6>
...
export default{
    ...
    computed:{
        edit(){
            return this.$store.state.medio.edit;
        },
        existe(){
            return this.$store.state.medio.existe
        },        
        editando(){
            return this.$store.state.medio.editando
        },
        editado(){
            return this.$store.state.medio.editado
        },
        deleting(){            
            return this.$store.state.medio.deleting
        },
        deleted(){            
            return this.$store.state.medio.deleted
        },
        err_nombre(){
    ...
    watch:{
        ...
        show(newValue){
            if(newValue){
                ...
                this.$store.dispatch('medio/edit', this.objId);
            }
        },
        editando(newValue){
            if(!newValue){
    ...
    methods:{
        ...
        submit(){
            ...
            if(cont>0)
            {
                this.$store.dispatch('medio/patch', { data:data, id:this.objId });
            }
            else{
                swal({
                    title: "Alerta",
        ...
        todelete(){
            swal({
                ...
                if (willDelete) {
                    this.$store.dispatch('medio/delete', this.objId);
                } else {
