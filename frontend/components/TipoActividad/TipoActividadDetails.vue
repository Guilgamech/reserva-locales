...
export default{
    ...
    computed:{
        ...
        editando(){
            return this.$store.state.tipo_actividad.editando
        },
        editado(){
            return this.$store.state.tipo_actividad.editado
        },
        deleting(){            
            return this.$store.state.tipo_actividad.deleting
        },
        deleted(){            
            return this.$store.state.tipo_actividad.deleted
        },
        err_nombre(){
    ...
    methods:{
        ...
        todelete(){
            swal({
                ...
                if (willDelete) {
                    this.$store.dispatch('tipo_actividad/delete', this.objId);
                } else {
