                    ...
                    <div v-else class="card-body">
                        <div v-if="!canedit" class="row">
                            <div class="col-5 justify-content-end">
                                ...
                                <h6 class="mb-2 text-end">Correo del Responsable:</h6>
                            ...
                            <div class="row justify-content-center text-center mt-3">
                                <div class="col-lg-4 cl-md-6 col-sm-6 col-12">
                                    <button type="button" @click="canedit=true" class="btn bg-gradient-success w-100 ">Editar</button>
                                </div>
                                <div class="col-lg-4 cl-md-6 col-sm-6 col-12">
                                    <button type="button" @click="todelete()" class="btn bg-gradient-primary w-100  ">Eliminar</button>
                                </div>
                                <div class="col-lg-4 cl-md-6 col-sm-6 col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <inputoutline
                                            ...
                                            type="text"
                                            v-model="item.responsable_email"
                                        />
                                    </div>
                                    <div class="col-12">
                                        <textareaoutline
...
export default{
    ...
    computed:{
        edit(){
            return this.$store.state.aseguramiento.edit;
        },
        existe(){
            return this.$store.state.aseguramiento.existe
        },        
        editando(){
            return this.$store.state.aseguramiento.editando
        },
        editado(){
            return this.$store.state.aseguramiento.editado
        },
        deleting(){            
            return this.$store.state.aseguramiento.deleting
        },
        deleted(){            
            return this.$store.state.aseguramiento.deleted
        },
        err_nombre(){
    ...
    watch:{
        ...
        show(newValue){
            if(newValue){
                ...
                this.$store.dispatch('aseguramiento/edit', this.objId);
            }
        },
        editando(newValue){
            if(!newValue){
    ...
    methods:{
        ...
        submit(){
            ...
            if(cont>0)
            {
                this.$store.dispatch('aseguramiento/patch', { data:data, id:this.objId });
            }
            else{
                swal({
                    title: "Alerta",
        ...
        todelete(){
            swal({
                ...
                if (willDelete) {
                    this.$store.dispatch('aseguramiento/delete', this.objId);
                } else {
