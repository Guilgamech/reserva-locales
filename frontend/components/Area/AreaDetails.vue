...
export default{
    ...
    computed:{
        edit(){
            return this.$store.state.area.edit;
        },
        existe(){
            return this.$store.state.area.existe
        },        
        editando(){
            return this.$store.state.area.editando
        },
        editado(){
            return this.$store.state.area.editado
        },
        deleting(){            
            return this.$store.state.area.deleting
        },
        deleted(){            
            return this.$store.state.area.deleted
        },
        err_nombre(){
    ...
    watch:{
        ...
        show(newValue){
            if(newValue){
                ...
                this.$store.dispatch('area/edit', this.objId);
            }
        },
        editando(newValue){
            if(!newValue){
    ...
    methods:{
        ...
        submit(){
            ...
            if(cont>0)
            {
                this.$store.dispatch('area/patch', { data:data, id:this.objId });
            }
            else{
                swal({
                    title: "Alerta",
        ...
        todelete(){
            swal({
                ...
                if (willDelete) {
                    this.$store.dispatch('area/delete', this.objId);
                } else {
